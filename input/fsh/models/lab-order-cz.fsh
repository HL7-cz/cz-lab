...
// -------------------------------------------------------------------------------				
Logical: LogEnOrderLabEhnCz				
Id: OrderCz			
Title: "A.2.1, A.2.2 - Order"				
Description:  """Order information and reason. Sections A2 and A3 of the eHN guideline."""				
* insert SetFmmandStatusRule ( 1, draft )			
* orderDetails 0..1 Base "A.2.1 Order information" """A.2 Order information (Laboratory Result Report could respond to multiple test orders) """				
...
* orderDetails.dateTime 0..1 dateTime "A.2.1.2 Order date and time" """Date and time of the order placement."""		 		
...
* orderDetails.orderPlacerContacts 0..1 Base "A.2.1.5 Order placer contact details" """Contact details of order placer (address and telecom details)."""				
...
* reason 0..* Base "A.2.2 Order reason" """A.2.2 Order reason (Laboratory Result Report could respond to multiple reasons) """				
