...
* contact.preferredPhysician.telecom 0..* ContactPoint "A.1.2.3.6 Telecom" """Telecommunication contact (e-mail, phone, etc.)."""

* contact.legalRepresent 0..* Base "A.1.2.4 Legal representatives and other contact persons" """"""
* contact.legalRepresent.type 0..1 CodeableConcept "A.1.2.4.1 Contact type" """Type of contact person distinguishing emergent contacts, legal guardians and other persons with a relationship to the patient.
- Preferred system(s): HL7 Role"""
* contact.legalRepresent.relationToSubject 0..1 CodeableConcept "A.1.2.4.2 Relationship to the patient" """Relationship of the person to the patient (father, son, daughter, etc.).
- Preferred system(s): eHDSIPersonalRelationship"""
* contact.legalRepresent.identifier 0..* Identifier  "A.1.2.4.3 Person identifier" """An identifier of the patient that is unique within a defined scope (birth number, passport number, etc.). Multiple identifiers could be provided. """
* contact.legalRepresent.givenName 1..* string "A.1.2.4.4 Given name" """The given name/first name of the person (also known as forename or first name)."""
* contact.legalRepresent.familyName 1..* string "A.1.2.4.5 Family name/surname" """The family name/surname/last name of the person."""
* contact.legalRepresent.address 0..1 Address "A.1.2.4.6 Contact person address" """Mailing, home and/or office address. Addresses are always a sequence of parts of an address (e.g. address line, country, zip code, city), although the format of the postal address may vary depending on the country. The address may contain information about the type of address; if this attribute is not present, it is assumed to be a default address usable for any purpose."""
* contact.legalRepresent.telecom 0..* ContactPoint "A.1.2.4.7 Telecom" """Telecommunication contact (e-mail, phone, etc.)."""
//--- END
//--- END
//--- END
