...
// -------------------------------------------------------------------------------				
Logical: LogEnRecipientLabEhnCz		
Id: RecipientCz				
...
* organizationIdentifier 0..1 Identifier "A.1.4.3 Recipient organization id" """Identifier of the recipient organization according to the NRPZS or IČO."""		 		
