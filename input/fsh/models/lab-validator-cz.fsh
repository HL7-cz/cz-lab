...
// -------------------------------------------------------------------------------				
Logical: LogEnValidatorLabEhnCz				
Id: ValidatorCz			
...
* organization 1..1 CZ_OrganizationCore "A.1.6.4 Result validator organisation" """The name and identification details of the healthcare facility represented by the person who verified the document.  """		 		
