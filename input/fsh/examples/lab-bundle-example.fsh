...
* entry[specimen][=].resource = Specimen-Krev-Serologie
* entry[specimen][+].fullUrl = "urn:uuid:b7a2f9d3-760f-4a89-bbbf-12199808f2e5"
* entry[specimen][=].resource = Specimen-Krev-Hematologie
* entry[specimen][+].fullUrl = "urn:uuid:04bb3e5b-83fb-41a5-b260-c91cdba5df80"
* entry[specimen][=].resource = Specimen-Moc

// Observations - moč
* entry[observation][+].fullUrl = "urn:uuid:172bc194-10b5-4e82-a9c3-2936b3b2523e"
* entry[observation][=].resource = Observation-SpecHmotnost
* entry[observation][+].fullUrl = "urn:uuid:b470bdf4-93ab-42d2-b5fb-c0dc69f87c72"
* entry[observation][=].resource = Observation-pH

// Observations - krev - minerály
* entry[observation][+].fullUrl = "urn:uuid:ad631612-fb27-4a7c-930e-73e22aff18f1"
* entry[observation][=].resource = Observation-Sodium
* entry[observation][+].fullUrl = "urn:uuid:9ba0669f-1a1e-4361-8d9b-70af9225fb4b"
* entry[observation][=].resource = Observation-Potassium
* entry[observation][+].fullUrl = "urn:uuid:5e058858-c126-4f0e-9202-ece18d3c9c3e"
* entry[observation][=].resource = Observation-Chloride

// Observations - krev - zanet. markery
* entry[observation][+].fullUrl = "urn:uuid:e2d39425-bc9b-4fcd-88fb-3499d14d8670"
* entry[observation][=].resource = Observation-CRP
* entry[observation][+].fullUrl = "urn:uuid:f53d66a1-c9c4-4b58-b04b-3c86a2ec0c16"
* entry[observation][=].resource = Observation-Prokalcitonin

// Observations - krev - serologie
* entry[observation][+].fullUrl = "urn:uuid:b0f7fc5d-d204-4e1c-b72f-83736e73efa4"
* entry[observation][=].resource = Observation-antiHAVIgM
* entry[observation][+].fullUrl = "urn:uuid:5eb7e3de-27a2-47bc-b67c-c085343f11eb"
* entry[observation][=].resource = Observation-antiHAVIgG
* entry[observation][+].fullUrl = "urn:uuid:dd34ef38-f949-4cc7-9b98-e2e3b55c84d5"
* entry[observation][=].resource = Observation-AntiHCV

// Observations - krev - hematologie
* entry[observation][+].fullUrl = "urn:uuid:a6c9f96b-23ea-4644-aadc-b11b8d3a17e2"
* entry[observation][=].resource = Observation-Leukocyty
* entry[observation][+].fullUrl = "urn:uuid:c4a42d64-5e43-449a-9460-3fd15cbbeff1"
* entry[observation][=].resource = Observation-Erytrocyty
* entry[observation][+].fullUrl = "urn:uuid:9b4c7d7f-8495-42bc-877f-b9864317ed38"
* entry[observation][=].resource = Observation-Hemoglobin
