...
* section insert OblCreator(#SHALL:able-to-populate,L2)
* section[annotations] insert OblCreator(#SHALL:able-to-populate,L2)
* section[attachment] insert OblCreator(#SHOULD:able-to-populate,L2)
...
* section insert OblCreator(#SHALL:able-to-populate,L3)
* section[annotations] insert OblCreator(#SHALL:able-to-populate,L3)
* section[attachment] insert OblCreator(#SHOULD:able-to-populate,L3)
...
* section insert OblConsumer(#SHALL:display,L2)
* section[annotations] insert OblConsumer(#SHALL:display,L2)
* section[attachment] insert OblConsumer(#SHOULD:display,L2)
...
* section insert OblConsumer(#SHALL:display,L3)
* section[annotations] insert OblConsumer(#SHALL:display,L3)
* section[attachment] insert OblConsumer(#SHOULD:display,L3)
