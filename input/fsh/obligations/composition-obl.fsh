...
* section[lab-no-subsections] insert OblCreator(#SHALL:able-to-populate,L2)
* section[lab-subsections] insert OblCreator(#SHALL:able-to-populate,L2)
* section[annotations] insert OblCreator(#SHALL:able-to-populate,L2)
