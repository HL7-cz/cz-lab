...
* group[=].element[=].display = "A.2.4.1 Laboratory report narrative"					
//-- unmatched					
//-- unmatched					
* group[=].element[=].target.equivalence = #unmatched					
					
* group[=].element[+].code = #Result.narrative.report					
* group[=].element[=].display = "A.2.4.1.1 Narrative report"					
//-- unmatched					
//-- unmatched					
* group[=].element[=].target.equivalence = #unmatched					
					
* group[=].element[+].code = #Result.narrative.notes					
* group[=].element[=].display = "A.2.4.1.2 Comments, interpretation and recommendations"					
//-- unmatched					
//-- unmatched					
* group[=].element[=].target.equivalence = #unmatched					
					
* group[=].element[+].code = #Result.observation					
* group[=].element[=].display = "A.2.4.2 Observation details"					
* group[=].element[=].target.code = #Observation					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
					
* group[=].element[+].code = #Result.observation.dateTime					
* group[=].element[=].display = "A.2.4.2.1 Observation date"					
...
* group[=].element[=].display = "A.2.4.2.3 Observation code"					
...
* group[=].element[=].display = "A.2.4.2.3.1 Observation name"					
...
//* group[=].element[=].display = "A.2.4.2.3.2 Observation original name"					
//* group[=].element[=].target.code = #Observation.code.text					
//* group[=].element[=].target.display = ""					
//* group[=].element[=].target.equivalence = #equivalent					
//* group[=].element[=].target.comment = "The mapping refers to the case 'code' mapped to Observation.code. A similar mapping applies to the other cases."					
//* group[=].element[+].code = #Result.observation.code.displayName					
//* group[=].element[=].display = "A.2.4.2.3.3 Observation display name"					
//* group[=].element[=].target.code = #Observation.code.coding.display					
//* group[=].element[=].target.display = ""					
//* group[=].element[=].target.equivalence = #equivalent					
//* group[=].element[=].target.comment = "The mapping refers to the case 'code' mapped to Observation.code. A similar mapping applies to the other cases.
//This element typically  represents the' short name' designation, compared to the 'full specified name' of the 'A.2.4.2.3.1 Observation name' element.
//It is not expected that both designations are recorded in the report; consumers can use in fact terminology services and/or lookup tables to allow users to have different displays for the same coded concept."					
* group[=].element[+].code = #Result.observation.method					
* group[=].element[=].display = "A.2.4.2.4 Observation method"					
* group[=].element[=].target.code = #Observation.method					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
					
* group[=].element[+].code = #Result.observation.device					
* group[=].element[=].display = "A.2.4.2.5 Observation device"					
...
* group[=].element[+].code = #Result.observation.device					
* group[=].element[=].display = "A.2.4.2.7 Observation device"					
...
* group[=].element[=].display = "A.2.4.2.11 Observation result"					
...
* group[=].element[=].display = "A.2.4.2.12 Observation interpretation"					
...
* group[=].element[=].display = "A.2.4.2.13 Result description"					
